...
Room* DatabaseUtil::getRoomData(int roomId) {
    ...
    while (roomSqlQuery.next()) {
        return new Room(STANDARDROOM, roomSqlQuery.value(0).toInt(), roomSqlQuery.value(1).toFloat(),
    ...
    roomSqlQuery.exec(str);
    while (roomSqlQuery.next()) {
        return new Room(BUSINESSSUIT, roomSqlQuery.value(0).toInt(), roomSqlQuery.value(1).toFloat(),
                    roomSqlQuery.value(2).toInt(), roomSqlQuery.value(3).toString());
    }
    ...
    roomSqlQuery.exec(str);
    while (roomSqlQuery.next()) {
        return new Room(HOURLYRATEROOM, roomSqlQuery.value(0).toInt(), roomSqlQuery.value(1).toFloat(),
                    roomSqlQuery.value(2).toInt(), roomSqlQuery.value(3).toString());
    }
    ...
    roomSqlQuery.exec(str);
    while (roomSqlQuery.next()) {
        return new Room(SPECIALDISCOUNTROOM, roomSqlQuery.value(0).toInt(), roomSqlQuery.value(1).toFloat(),
...
RoomList* DatabaseUtil::getRoomDataList() {
    ...
    while (roomSqlQuery.next()) {
        Room* room = new Room(STANDARDROOM, roomSqlQuery.value(0).toInt(), roomSqlQuery.value(1).toFloat(),
                              roomSqlQuery.value(2).toInt(), roomSqlQuery.value(3).toString());
        if (isFirst) {
            roomList = new RoomList(room);
            isFirst = false;
        }
        else {
    ...
    while (roomSqlQuery.next()) {
        Room* room = new Room(BUSINESSSUIT, roomSqlQuery.value(0).toInt(), roomSqlQuery.value(1).toFloat(),
                              roomSqlQuery.value(2).toInt(), roomSqlQuery.value(3).toString());
        if (isFirst) {
            roomList = new RoomList(room);
            isFirst = false;
    ...
    while (roomSqlQuery.next()) {
        Room* room = new Room(HOURLYRATEROOM, roomSqlQuery.value(0).toInt(), roomSqlQuery.value(1).toFloat(),
                              roomSqlQuery.value(2).toInt(), roomSqlQuery.value(3).toString());
        if (isFirst) {
            roomList = new RoomList(room);
            isFirst = false;
    ...
    while (roomSqlQuery.next()) {
        Room* room = new Room(SPECIALDISCOUNTROOM, roomSqlQuery.value(0).toInt(), roomSqlQuery.value(1).toFloat(),
                              roomSqlQuery.value(2).toInt(), roomSqlQuery.value(3).toString(), roomSqlQuery.value(4).toString());
        if (isFirst) {
            roomList = new RoomList(room);
            isFirst = false;
...
Customer* DatabaseUtil::getCustomerData(int customerId) {
    ...
    while (customerSqlQuery.next()) {
        return new Customer(ORDINARY, customerSqlQuery.value(0).toInt(), customerSqlQuery.value(1).toString(),
    ...
    customerSqlQuery.exec(str);
    while (customerSqlQuery.next()) {
        return new Customer(VIP, customerSqlQuery.value(0).toInt(), customerSqlQuery.value(1).toString(),
                            customerSqlQuery.value(2).toString(), customerSqlQuery.value(3).toString(),
                            customerSqlQuery.value(4).toString(), customerSqlQuery.value(5).toString(),
    ...
    customerSqlQuery.exec(str);
    while (customerSqlQuery.next()) {
        return new Customer(SVIP, customerSqlQuery.value(0).toInt(), customerSqlQuery.value(1).toString(),
                            customerSqlQuery.value(2).toString(), customerSqlQuery.value(3).toString(),
                            customerSqlQuery.value(4).toString(), customerSqlQuery.value(5).toString(),
                            customerSqlQuery.value(6).toString(), customerSqlQuery.value(7).toString(),
...
CustomerList* DatabaseUtil::getCustomerDataList() {
    ...
    while (customerSqlQuery.next()) {
        Customer* customer = new Customer(ORDINARY, customerSqlQuery.value(0).toInt(), customerSqlQuery.value(1).toString(),
                                          customerSqlQuery.value(2).toString(), customerSqlQuery.value(3).toString(),
                                          customerSqlQuery.value(4).toString(), customerSqlQuery.value(5).toString(),
                                          customerSqlQuery.value(6).toString());
        if (isFirst) {
    ...
    while (customerSqlQuery.next()) {
        Customer* customer = new Customer(VIP, customerSqlQuery.value(0).toInt(), customerSqlQuery.value(1).toString(),
                                          customerSqlQuery.value(2).toString(), customerSqlQuery.value(3).toString(),
                                          customerSqlQuery.value(4).toString(), customerSqlQuery.value(5).toString(),
                                          customerSqlQuery.value(6).toString(), customerSqlQuery.value(7).toString(),
                                          customerSqlQuery.value(8).toInt()
    ...
    while (customerSqlQuery.next()) {
        Customer* customer = new Customer(SVIP, customerSqlQuery.value(0).toInt(), customerSqlQuery.value(1).toString(),
                                          customerSqlQuery.value(2).toString(), customerSqlQuery.value(3).toString(),
                                          customerSqlQuery.value(4).toString(), customerSqlQuery.value(5).toString(),
                                          customerSqlQuery.value(6).toString(), customerSqlQuery.value(7).toString(),
                                          customerSqlQuery.value(8).toInt(), customerSqlQuery.value(9).toFloat()
